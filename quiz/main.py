...
try:
    nebula_images = {
        "neutral": pygame.image.load("game version 2.0/VisualNovel-20250419T204507Z-001/VisualNovel/images/characters/nebulaNeutral.png").convert_alpha(),
        "angry": pygame.image.load("game version 2.0/VisualNovel-20250419T204507Z-001/VisualNovel/images/characters/nebulaAngry.png").convert_alpha(),
        "confirm": pygame.image.load("game version 2.0/VisualNovel-20250419T204507Z-001/VisualNovel/images/characters/nebulaConfirm.png").convert_alpha(),
        "notification": pygame.image.load("game version 2.0/VisualNovel-20250419T204507Z-001/VisualNovel/images/characters/nebulaNotification.png").convert_alpha()
    }
    ...
    print("Please verify:")
    print("1. The image files exist in the specified paths")
    print("2. The file names are exactly matching (case-sensitive)")
    print("3. The images are in PNG format")
    pygame.quit()
    sys.exit()
...
class DialogueBox:
    ...
    def draw(self, surface):
        # Background overlay first
        overlay = pygame.Surface((WIDTH, HEIGHT), pygame.SRCALPHA)
        overlay.fill((0, 0, 0, 180))
        surface.blit(overlay, (0, 0))
        
        # Draw Nebula character before the dialogue box
        nebula_x = self.rect.x - 300  # Position to the left of the dialog box
        nebula_y = self.rect.centery - 125
        surface.blit(self.nebula_image, (nebula_x, nebula_y))
...
def update_question():
    global quiz_buttons
    quiz_buttons = [
        Button((WIDTH-BUTTON_WIDTH)//2, 200+i*100, 
...
def draw_main_screen():
    ...
    # Only draw neutral Nebula during quiz state
    ...
    q_surf = font_medium.render(q_text, True, COLORS["primary"])
    q_rect = q_surf.get_rect(center=(WIDTH//2, 160))
